...
$("#info").onclick = () => {
	popup('<h1>Instructions</h1>Hit enter to send a message and shift-enter to create a new line.<h2>Commands</h2><ol><li>/clear - Clears the chat</li><li>/ignore{user} - Ignores the user in the chat</li></ol></div>');
}
